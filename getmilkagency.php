...
$query="select  *  from agency where agency_active=0 and agency_id in (select agency_id from agency_category where cat_id=2 and agency_id in(select agency_id from area_by_agency where area_id=".$area_id.") )";
			$arr;
